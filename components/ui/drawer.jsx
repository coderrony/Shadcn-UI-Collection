...
const DrawerContent = React.forwardRef(
  ({ className, children, ...props }, ref) => {
    const { direction, onClose } = React.useContext(DrawerContext);

    // Close drawer on item click
    const handleItemClick = () => {
      if (onClose) {
        onClose(); // Call the onClose function passed to the drawer to close it
      }
    };
    ...
    return (
      <DrawerPortal>
        ...
        >
          ...
          {/* Wrap children with the close functionality */}
